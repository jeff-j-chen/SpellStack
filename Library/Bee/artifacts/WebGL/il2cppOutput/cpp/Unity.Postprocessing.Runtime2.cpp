...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void U3CU3Ec__cctor_m26E6EFBFBBC1F858E452CC4D882B5469B50F0F98 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		U3CU3Ec__ctor_m90691D1FA1D38AC16E174EC5EA02291F7F1FDD7B(L_0, /*hidden argument*/NULL);
...
IL_000a:
	...
	}
	{
		...
		AnimationCurve__ctor_m0D976567166F92383307DC8EB8D7082CD34E226F(L_7, /*hidden argument*/NULL);
...
IL_003b:
	{
		...
		L_10 = AnimationCurve_get_Item_mD4E73EE674F7A82673F1A9CEB8E5EF86BA47E64B(L_8, ((int32_t)il2cpp_codegen_subtract((int32_t)L_9, (int32_t)1)), NULL);
		V_1 = L_10;
		// prev.time -= m_Range;
		...
		Keyframe_set_time_m98F165193486C0DF1611B562016595B18052A2D6(L_11, ((float)il2cpp_codegen_subtract((float)L_12, (float)L_13)), NULL);
		// var next = curve[0];
		...
		Keyframe_set_time_m98F165193486C0DF1611B562016595B18052A2D6(L_16, ((float)il2cpp_codegen_add((float)L_17, (float)L_18)), NULL);
...
IL_00b3:
	{
		...
		int32_t L_31 = V_0;
		float L_32;
		L_32 = Spline_Evaluate_m908B44D36171764274B429D923E47F36BF972516(__this, ((float)il2cpp_codegen_multiply((float)((float)((float)L_30)), (float)(0.0078125f))), L_31, NULL);
...
{
	{
		...
		// return hash;
		return ((int32_t)il2cpp_codegen_add((int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)17), (int32_t)((int32_t)23))), (int32_t)L_1));
	}
}
#ifdef __clang__
#pragma clang diagnostic pop
...
{
	{
		...
		__this->___m_Current_1 = ((int32_t)il2cpp_codegen_add((int32_t)L_2, (int32_t)1));
		// return ret;
		return L_1;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextureFormatUtilities__cctor_m80F059F44CECC5A39BFE15307B85CDB3A8C0154C (const RuntimeMethod* method)
{
	...
	il2cpp::utils::ExceptionSupportStack<int32_t, 2> __leave_targets;
	{
		...
		Dictionary_2__ctor_mAEC79FC89BB27663084F0D041157806C2B4858B4(L_0, /*hidden argument*/Dictionary_2__ctor_mAEC79FC89BB27663084F0D041157806C2B4858B4_RuntimeMethod_var);
		...
		Dictionary_2__ctor_m1AE7A14FE6CF65276434BAC094AE2F7269D06024(L_39, /*hidden argument*/Dictionary_2__ctor_m1AE7A14FE6CF65276434BAC094AE2F7269D06024_RuntimeMethod_var);
...
IL_0183:
		{
			...
			if ((((int32_t)((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_46, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var))))) < ((int32_t)0)))
			{
				goto IL_01b8;
			}
		}
...
IL_0193:
		{
			...
			bool L_48;
			L_48 = TextureFormatUtilities_IsObsolete_m7F982EEAB23550BC1C661F9498072043C17A2B15(L_47, NULL);
			if (L_48)
			{
				goto IL_01b8;
			}
...
IL_019b:
		{
			...
			bool L_50;
			L_50 = SystemInfo_SupportsRenderTextureFormat_mFF17D2CC50B98C7859CE0536524C612965ACF763(((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_49, RenderTextureFormat_tB6F1ED5040395B46880CE00312D2FDDBF9EEB40F_il2cpp_TypeInfo_var)))), NULL);
			V_2 = L_50;
			// s_SupportedRenderTextureFormats[(int)format] = supported;
			Dictionary_2_t01224C8DBCCFE276E97D2BF52F4D7B10D3642682* L_51 = ((TextureFormatUtilities_t68E492E14F6DE04D603579FC02F042ED0174572D_StaticFields*)il2cpp_codegen_static_fields_for(TextureFormatUtilities_t68E492E14F6DE04D603579FC02F042ED0174572D_il2cpp_TypeInfo_var))->___s_SupportedRenderTextureFormats_1;
			RuntimeObject* L_52 = V_1;
			bool L_53 = V_2;
			Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48(L_51, ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_52, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var)))), L_53, Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48_RuntimeMethod_var);
		}
...
IL_01c0:
		{
			IL2CPP_LEAVE(0x467, FINALLY_01c2);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
	...
	{// begin finally (depth: 1)
		{
			...
			V_3 = ((RuntimeObject*)IsInst((RuntimeObject*)L_56, IDisposable_t030E0496B4E0E4E4F086825007979AF51F7248C5_il2cpp_TypeInfo_var));
...
IL_01d3:
	{
		...
		Dictionary_2__ctor_m1AE7A14FE6CF65276434BAC094AE2F7269D06024(L_59, /*hidden argument*/Dictionary_2__ctor_m1AE7A14FE6CF65276434BAC094AE2F7269D06024_RuntimeMethod_var);
...
IL_01f4:
		{
			...
			RuntimeObject* L_65;
			L_65 = InterfaceFuncInvoker0< RuntimeObject* >::Invoke(1 /* System.Object System.Collections.IEnumerator::get_Current() */, IEnumerator_t7B609C2FFA6EB5167D9C62A0C32A21DE2F666DAA_il2cpp_TypeInfo_var, L_64);
			V_4 = L_65;
			// if ((int)format < 0) // Crashes the runtime otherwise (!)
			RuntimeObject* L_66 = V_4;
			if ((((int32_t)((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_66, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var))))) < ((int32_t)0)))
			{
				goto IL_0230;
			}
		}
...
IL_0206:
		{
			...
			bool L_68;
			L_68 = TextureFormatUtilities_IsObsolete_m7F982EEAB23550BC1C661F9498072043C17A2B15(L_67, NULL);
			if (L_68)
			{
				goto IL_0230;
			}
...
IL_020f:
		{
			...
			bool L_70;
			L_70 = SystemInfo_SupportsTextureFormat_mB0695AD83D5244AFA9D65520E13FBC54F438A43D(((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_69, TextureFormat_t87A73E4A3850D3410DC211676FC14B94226C1C1D_il2cpp_TypeInfo_var)))), NULL);
			V_5 = L_70;
			// s_SupportedTextureFormats[(int)format] = supported;
			Dictionary_2_t01224C8DBCCFE276E97D2BF52F4D7B10D3642682* L_71 = ((TextureFormatUtilities_t68E492E14F6DE04D603579FC02F042ED0174572D_StaticFields*)il2cpp_codegen_static_fields_for(TextureFormatUtilities_t68E492E14F6DE04D603579FC02F042ED0174572D_il2cpp_TypeInfo_var))->___s_SupportedTextureFormats_2;
			RuntimeObject* L_72 = V_4;
			bool L_73 = V_5;
			Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48(L_71, ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_72, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var)))), L_73, Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48_RuntimeMethod_var);
		}
...
IL_0238:
		{
			IL2CPP_LEAVE(0x587, FINALLY_023a);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
	...
	{// begin finally (depth: 1)
		{
			...
			V_3 = ((RuntimeObject*)IsInst((RuntimeObject*)L_76, IDisposable_t030E0496B4E0E4E4F086825007979AF51F7248C5_il2cpp_TypeInfo_var));
...
IL_0014:
	...
	}
	{
		...
		NotSupportedException__ctor_mE174750CF0247BBB47544FFD71D66BB89630945B(L_9, ((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral96AFB5CB3B476CE64056EF8716AEA14B385714ED)), /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR TextureLerper_t3EAB762818E71EC9F4627D4BF1C4428DF9570424* TextureLerper_get_instance_mCC583A6374F5049A37F412180FED1BA4713728F7 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		TextureLerper__ctor_m326A48946F64C5733E75607AE62A9D247FC7E67D(L_1, /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextureLerper__ctor_m326A48946F64C5733E75607AE62A9D247FC7E67D (TextureLerper_t3EAB762818E71EC9F4627D4BF1C4428DF9570424* __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		List_1__ctor_mD0891E1C91B860AD22385685DAAFF9988CA4CB49(L_0, /*hidden argument*/List_1__ctor_mD0891E1C91B860AD22385685DAAFF9988CA4CB49_RuntimeMethod_var);
		...
		List_1__ctor_mD0891E1C91B860AD22385685DAAFF9988CA4CB49(L_1, /*hidden argument*/List_1__ctor_mD0891E1C91B860AD22385685DAAFF9988CA4CB49_RuntimeMethod_var);
...
IL_0085:
		{
			IL2CPP_LEAVE(0x149, FINALLY_0087);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
...
IL_0067:
	...
	}
	{
		...
		if (((int32_t)((int32_t)((((int32_t)L_29) > ((int32_t)1))? 1 : 0)|(int32_t)L_30)))
		{
			goto IL_007d;
		}
	}
...
IL_007e:
	{
		...
		RenderTexture__ctor_m53215A8EDDE262932758186108347685F6A512C4(L_34, L_31, L_32, 0, L_33, /*hidden argument*/NULL);
...
IL_0068:
	{
		...
		Vector4__ctor_m96B2CD8B862B271F513AF0BDC2EABD58E4DBC813_inline((&L_43), ((float)((float)L_38)), ((float)((float)L_40)), ((float)((float)L_41)), L_42, /*hidden argument*/NULL);
		...
		uint32_t L_62 = V_6;
		int32_t L_63;
		L_63 = Mathf_CeilToInt_m04999E3DEB696135EFD620A30F51503D700C1998_inline(((float)((float)((float)((float)L_61))/(float)((float)((float)((double)((uint32_t)L_62)))))), NULL);
		V_9 = L_63;
		// int groupSizeZ = Mathf.CeilToInt(size / (float)tgsZ);
		uint32_t L_64 = V_8;
		int32_t L_65;
		L_65 = Mathf_CeilToInt_m04999E3DEB696135EFD620A30F51503D700C1998_inline(((float)((float)((float)((float)L_61))/(float)((float)((float)((double)((uint32_t)L_64)))))), NULL);
		V_10 = L_65;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Texture_t791CBB51219779964E0E8A2ED7C1AA5F92A4A700* TextureLerper_Lerp_mF45DC5D430B5C7B0C0067B55F390910DE27232DA (TextureLerper_t3EAB762818E71EC9F4627D4BF1C4428DF9570424* __this, Texture_t791CBB51219779964E0E8A2ED7C1AA5F92A4A700* ___from0, Color_tD001788D726C3A7F1379BEED0260B9591F440C1F ___to1, float ___t2, const RuntimeMethod* method)
{
	...
	int32_t G_B11_0 = 0;
	{
		// if (t < 0.00001)
		float L_0 = ___t2;
		if ((!(((double)((double)((double)L_0))) < ((double)(1.0000000000000001E-05)))))
		{
			goto IL_000f;
		}
	}
...
IL_0058:
	{
		...
		Vector4__ctor_m96B2CD8B862B271F513AF0BDC2EABD58E4DBC813_inline((&L_37), ((float)((float)L_32)), ((float)((float)L_34)), ((float)((float)L_35)), L_36, /*hidden argument*/NULL);
		...
		int32_t L_59;
		L_59 = Mathf_CeilToInt_m04999E3DEB696135EFD620A30F51503D700C1998_inline(((float)((float)((float)((float)L_17))/(float)(4.0f))), NULL);
		V_6 = L_59;
...
IL_0056:
		{
			IL2CPP_LEAVE(0x102, FINALLY_0058);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
